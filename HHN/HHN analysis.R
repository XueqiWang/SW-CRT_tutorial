...
# GEE/UEE
fit_cie_nex_uee <- cpgeeSWD(y=y, X=X, id=id, m=m, corstr="nest_exch", family="binomial", epsilon=1e-8, alpadj=FALSE)
fit_cie_nex_uee
...
# GEE/MAEE
fit_cie_nex_maee <- cpgeeSWD(y=y, X=X, id=id, m=m, corstr="nest_exch", family="binomial", epsilon=1e-8, alpadj=TRUE)
fit_cie_nex_maee
# GEE and MAEE for Cluster-Period Summaries 
...
# GEE/UEE
fit_cie_ed_uee <- cpgeeSWD(y=y, X=X, id=id, m=m, corstr="exp_decay", family="binomial", epsilon=1e-8, alpadj=FALSE)
fit_cie_ed_uee
# GEE and MAEE for Cluster-Period Summaries 
# Number of Iterations: 8 
# Results for marginal mean parameters 
...
# GEE/MAEE
fit_cie_ed_maee <- cpgeeSWD(y=y, X=X, id=id, m=m, corstr="exp_decay", family="binomial", epsilon=1e-8, alpadj=TRUE)
fit_cie_ed_maee
# GEE and MAEE for Cluster-Period Summaries 
# Number of Iterations: 9 
# Results for marginal mean parameters 
...
tab1_beta <- data.frame(c1=beta_est_row(fit_cie_nex_uee), c1s=beta_se_row(fit_cie_nex_uee,0), 
                        c2=beta_est_row(fit_cie_nex_maee), c2s=beta_se_row(fit_cie_nex_maee,1),
                        c3=beta_est_row(fit_cie_ed_uee), c3s=beta_se_row(fit_cie_ed_uee,0),
                        c4=beta_est_row(fit_cie_ed_maee), c4s=beta_se_row(fit_cie_ed_maee,1))
...
tab1_alpha <- data.frame(c1=alpha_est_row(fit_cie_nex_uee), c1s=alpha_se_row(fit_cie_nex_uee,0), 
                         c2=alpha_est_row(fit_cie_nex_maee), c2s=alpha_se_row(fit_cie_nex_maee,2),
                         c3=alpha_est_row(fit_cie_ed_uee), c3s=alpha_se_row(fit_cie_ed_uee,0),
                         c4=alpha_est_row(fit_cie_ed_maee), c4s=alpha_se_row(fit_cie_ed_maee,2))
...
sum(diag( Ustar(y=y,m=m,X=X,beta=fit_cie_nex_uee$beta) %*% (fit_cie_nex_uee$BC1[1:13,1:13]) )) # 16955.37
sum(diag( Ustar(y=y,m=m,X=X,beta=fit_cie_nex_maee$beta) %*% (fit_cie_nex_maee$BC1[1:13,1:13]) )) # 16954.5
sum(diag( Ustar(y=y,m=m,X=X,beta=fit_cie_ed_uee$beta) %*% (fit_cie_ed_uee$BC1[1:13,1:13]) )) # 16194.54
sum(diag( Ustar(y=y,m=m,X=X,beta=fit_cie_ed_maee$beta) %*% (fit_cie_ed_maee$BC1[1:13,1:13]) )) # 16194.49
...
tabm_beta <- data.frame(c1=beta_row(fit_eiie_ed_uee,0), c2=beta_p(fit_eiie_ed_uee,0), c3=beta_ci(fit_eiie_ed_uee,0), 
                    c4=beta_row(fit_cie_ed_uee,1), c5=beta_p(fit_cie_ed_uee,1), c6=beta_ci(fit_cie_ed_uee,1))
xtable(tabm_beta)
# \begin{table}[ht]
# \centering
...
tabm_alpha <- data.frame(c1=alpha_row(fit_eiie_ed_uee,0), c2=alpha_p(fit_eiie_ed_uee,0), c3=alpha_ci(fit_eiie_ed_uee,0), 
                         c4=alpha_row(fit_cie_ed_uee,2), c5=alpha_p(fit_cie_ed_uee,2), c6=alpha_ci(fit_cie_ed_uee,2))
xtable(tabm_alpha)
# \begin{table}[ht]
# \centering
# \begin{tabular}{rllllll}
...
tabs_beta <- data.frame(c1=beta_row(fit_eiie_nex_uee,0), c2=beta_p(fit_eiie_nex_uee,0), c3=beta_ci(fit_eiie_nex_uee,0), 
                    c4=beta_row(fit_cie_nex_uee,1), c5=beta_p(fit_cie_nex_uee,1), c6=beta_ci(fit_cie_nex_uee,1))
xtable(tabs_beta)
# \begin{table}[ht]
# \centering
# \begin{tabular}{rllllll}
...
tabs_alpha <- data.frame(c1=alpha_row(fit_eiie_nex_uee,0), c2=alpha_p(fit_eiie_nex_uee,0), c3=alpha_ci(fit_eiie_nex_uee,0), 
                         c4=alpha_row(fit_cie_nex_uee,2), c5=alpha_p(fit_cie_nex_uee,2), c6=alpha_ci(fit_cie_nex_uee,2))
xtable(tabs_alpha)
# \begin{table}[ht]
# \centering
# \begin{tabular}{rllllll}
